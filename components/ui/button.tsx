  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        elite: "bg-gradient-to-r from-indigo-500 via-purple-500 to-purple-600 text-white shadow-md hover:shadow-lg hover:shadow-indigo-500/25 hover:scale-[1.02]",
        "elite-outline": "border-2 border-indigo-500/50 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-500/10 hover:border-indigo-500",
        ...
        glass: "bg-white/70 dark:bg-gray-900/70 backdrop-blur-md border border-white/30 dark:border-white/10 shadow-sm hover:bg-white/80 dark:hover:bg-gray-900/80",
      },
      size: {
